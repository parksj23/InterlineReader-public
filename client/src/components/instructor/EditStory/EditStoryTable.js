...
class EditStoryTable extends React.Component {
    ...
    render() {
        ...
        this.props.tableHeaders.forEach(aTableHeader => {
            tableHeaders.push(<CustomTableCell align="left">{aTableHeader.label}</CustomTableCell>);
        })
        ...
        return (
            <Paper className={classes.root} style={{width: '90%', marginLeft: '5%'}}>
...
EditStoryTable.propTypes = {
    classes: PropTypes.object.isRequired
};
export default withStyles(styles)(EditStoryTable);
