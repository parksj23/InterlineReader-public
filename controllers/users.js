...
exports.register = async (req, res) => {
	...
	const emailData = {
		subject: 'Email Verification - InterlineReader',
		recipients: [user.email],
		from_email: 'no-reply@interlinereader.com',
	};
	...
	//await mailer.send(); // TODO: Add back after implementing Sendgrid
...
exports.sendResetPasswordEmail = async (req, res) => {
	...
	const emailData = {
		subject: 'Reset password - InterlineReader',
		recipients: [user.email],
		from_email: 'no-reply@interlinereader.com',
	};
